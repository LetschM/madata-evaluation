...
return <data><count comment="total amount of eprints">{count($eprints)}</count><count comment="total amount of documents">{count($documents)}</count><count comment="total amount of different creators">{count($creators)}</count><count comment="eprints with dates">{count($a)}</count><count comment="eprints with responsibility">{count($b)}</count><count comment="eprints with documents">{count($c)}</count><count comment="eprints with title">{count($d)}</count><count comment="eprints with subject">{count($e)}</count><count comment="eprints with keywords">{count($f)}</count><count comment="eprints with abstract">{count($g)}</count><count comment="eprints with ubma project">{count($h)}</count><count comment="files with license">{count($i)}</count></data>